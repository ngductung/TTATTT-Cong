...
import Controller.CongController;
import Controller.CongControllerKey;
import Model.CongModel;
...
public class CongView extends JFrame {
	...
	public CongModel model = new CongModel();

	/**
	 * Create the frame.
	 * @throws IOException 
	 */
	public CongView() throws IOException {
		setTitle("Cộng");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setIconImage(ImageIO.read(new File(".\\icon.png")));
		CongController controller = new CongController(this);
		CongControllerKey key = new CongControllerKey(this);
